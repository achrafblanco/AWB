...
import tn.esprit.commande.Services.ICommandeService;
...
@RestController
@AllArgsConstructor
@RequestMapping("/commande-service/Commande")
@CrossOrigin(origins = "http://localhost:4200, http://localhost:53570")
public class CommandeController {


    @Autowired
    private ICommandeService commandeService; // Injection avec @Autowired
    ...
    public Integer getCommandeCount() {
        return commandeService.getCommandeCount();
